...
var (
	...
	BEpusdtAPIURL string = getEnv("BEpusdtAPIURL", "https://bepusdt.ai-key.top")
	...
	BEpusdtWalletAddress string = getEnv("BEpusdtWalletAddress", "TZGm3kFjQpEimu6i632M77KpiMip3J9gws")
)
